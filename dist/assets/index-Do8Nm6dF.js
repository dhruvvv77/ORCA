(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();let V="en";const oe={en:"English",hi:"हिन्दी",bn:"বাংলা",ta:"தமிழ்",te:"తెలుగు",mr:"मराठी",gu:"ગુજરાતી",kn:"ಕನ್ನಡ",ml:"മലയാളം",pa:"ਪੰਜਾਬੀ",ur:"اردو"};function U(){return V}function $e(e){oe[e]&&(V=e,localStorage.setItem("weathergpt-lang",e))}function Se(){const e=localStorage.getItem("weathergpt-lang");return e&&oe[e]&&(V=e),V}function ye(){const e={en:"Ask about fishing zones, ocean conditions, weather...",hi:"कहीं भी मौसम के बारे में पूछें...",bn:"যেকোনো জায়গার আবহাওয়া সম্পর্কে জিজ্ঞাসা করুন...",ta:"எங்கும் வானிலை பற்றி கேளுங்கள்...",te:"ఎక్కడైనా వాతావరణం గురించి అడగండి...",mr:"कुठेही हवामानाबद्दल विचारा...",gu:"ગમે ત્યાં હવામાન વિશે પૂછો...",kn:"ಎಲ್ಲಿಯಾದರೂ ಹವಾಮಾನದ ಬಗ್ಗೆ ಕೇಳಿ...",ml:"എവിടെയും കാലാവസ്ഥയെക്കുറിച്ച് ചോദിക്കൂ...",pa:"ਕਿਤੇ ਵੀ ਮੌਸਮ ਬਾਰੇ ਪੁੱਛੋ...",ur:"...کہیں بھی موسم کے بارے میں پوچھیں"};return e[V]||e.en}let P=null,G=!1,O=!1,J=null,A=null;const j={en:"en-IN",hi:"hi-IN",bn:"bn-IN",ta:"ta-IN",te:"te-IN",mr:"mr-IN",gu:"gu-IN",kn:"kn-IN",ml:"ml-IN",pa:"pa-IN",ur:"ur-IN"};function be(){return!!(window.SpeechRecognition||window.webkitSpeechRecognition)}function we(){return!!window.speechSynthesis}function Me(e,t){J=e,A=t;const n=window.SpeechRecognition||window.webkitSpeechRecognition;return n?(P=new n,P.continuous=!1,P.interimResults=!1,P.maxAlternatives=1,P.onresult=a=>{const s=a.results[0][0].transcript;J&&J(s)},P.onend=()=>{G=!1,A&&A("stopped")},P.onerror=a=>{console.warn("Speech recognition error:",a.error),G=!1,a.error==="not-allowed"?A&&A("denied"):A&&A("error")},!0):(console.warn("SpeechRecognition not supported"),!1)}function Te(){if(!P)return;if(G){Ee();return}const e=U();P.lang=j[e]||"en-IN";try{P.start(),G=!0,A&&A("listening")}catch(t){console.warn("Failed to start recognition:",t),A&&A("error")}}function Ee(){P&&G&&(P.stop(),G=!1,A&&A("stopped"))}function Ae(e){var c;if(!window.speechSynthesis||!O)return;window.speechSynthesis.cancel();const t=e.replace(/[\u{1F300}-\u{1FAFF}]/gu,"").replace(/[*_~`#]/g,"").trim();if(!t)return;const n=new SpeechSynthesisUtterance(t),a=U();n.lang=j[a]||"en-IN",n.rate=1,n.pitch=1,n.volume=.9;const s=window.speechSynthesis.getVoices(),i=((c=j[a])==null?void 0:c.split("-")[0])||"en",r=s.find(o=>o.lang.startsWith(i));r&&(n.voice=r),window.speechSynthesis.speak(n)}function _e(e,t){var o;if(!window.speechSynthesis){t&&t();return}window.speechSynthesis.cancel();const n=e.replace(/[\u{1F300}-\u{1FAFF}]/gu,"").replace(/[*_~`#]/g,"").trim();if(!n){t&&t();return}const a=new SpeechSynthesisUtterance(n),s=U();a.lang=j[s]||"en-IN",a.rate=1,a.pitch=1,a.volume=.9;const i=window.speechSynthesis.getVoices(),r=((o=j[s])==null?void 0:o.split("-")[0])||"en",c=i.find(p=>p.lang.startsWith(r));c&&(a.voice=c),t&&(a.onend=()=>t(),a.onerror=()=>t()),window.speechSynthesis.speak(a)}function xe(){var e;return O=!O,localStorage.setItem("weathergpt-autospeak",O),O||(e=window.speechSynthesis)==null||e.cancel(),O}function Ne(){return O}function Pe(){return O=localStorage.getItem("weathergpt-autospeak")==="true",O}const qe={"01d":"☀️","01n":"🌙","02d":"⛅","02n":"☁️","03d":"☁️","03n":"☁️","04d":"☁️","04n":"☁️","09d":"🌧️","09n":"🌧️","10d":"🌦️","10n":"🌧️","11d":"⛈️","11n":"⛈️","13d":"❄️","13n":"❄️","50d":"🌫️","50n":"🌫️"};function Ie(e){return qe[e]||"🌡️"}function Fe(e,t){if(!(t!=null&&t.forecast)||!window.Chart)return null;const n=t.forecast,a=document.createElement("canvas");a.classList.add("forecast-chart-canvas"),e.appendChild(a);const s=n.map(h=>h.day_name),i=n.map(h=>h.temperature.high),r=n.map(h=>h.temperature.low),c=a.getContext("2d"),o=c.createLinearGradient(0,0,0,200);o.addColorStop(0,"rgba(245, 158, 11, 0.3)"),o.addColorStop(1,"rgba(245, 158, 11, 0.02)");const p=c.createLinearGradient(0,0,0,200);return p.addColorStop(0,"rgba(96, 165, 250, 0.2)"),p.addColorStop(1,"rgba(96, 165, 250, 0.02)"),new Chart(c,{type:"line",data:{labels:s,datasets:[{label:"High",data:i,borderColor:"#f59e0b",backgroundColor:o,borderWidth:2.5,fill:!0,tension:.4,pointBackgroundColor:"#f59e0b",pointBorderColor:"#1a2035",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7},{label:"Low",data:r,borderColor:"#60a5fa",backgroundColor:p,borderWidth:2.5,fill:!0,tension:.4,pointBackgroundColor:"#60a5fa",pointBorderColor:"#1a2035",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{intersect:!1,mode:"index"},plugins:{legend:{display:!0,position:"top",align:"end",labels:{color:"#94a3b8",font:{family:"'Inter', sans-serif",size:11},boxWidth:12,boxHeight:2,useBorderRadius:!0,borderRadius:1,padding:12}},tooltip:{backgroundColor:"rgba(17, 24, 39, 0.95)",titleColor:"#f1f5f9",bodyColor:"#94a3b8",borderColor:"rgba(255, 255, 255, 0.06)",borderWidth:1,cornerRadius:8,padding:10,titleFont:{family:"'Inter', sans-serif",weight:"600"},bodyFont:{family:"'Inter', sans-serif"},callbacks:{label:h=>`${h.dataset.label}: ${h.parsed.y}°C`}}},scales:{x:{grid:{display:!1},border:{display:!1},ticks:{color:"#64748b",font:{family:"'Inter', sans-serif",size:11,weight:"500"}}},y:{grid:{color:"rgba(255, 255, 255, 0.04)",drawTicks:!1},border:{display:!1},ticks:{color:"#64748b",font:{family:"'Inter', sans-serif",size:11},padding:8,callback:h=>`${h}°`}}}}})}let B=null,E=null,K=null;const He=[15.5,76.2],F=(e="")=>String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]);function te(e,t){const n=Math.PI/180,a=(t.lat-e.lat)*n,s=(t.lon-e.lon)*n,i=Math.sin(a/2)**2+Math.cos(e.lat*n)*Math.cos(t.lat*n)*Math.sin(s/2)**2;return 6371*2*Math.atan2(Math.sqrt(i),Math.sqrt(1-i))}function Q(e){var a,s;const t=e.risk.level==="favourable"?20:e.risk.level==="caution"?5:-30,n=((s=(a=e.ocean)==null?void 0:a.wave)==null?void 0:s.significant_height_m)||0;return e.confidence*100+t-e.wind_speed_knots*.35-n*2}function ce(e){return`<div class="marine-popup">
  ...
  </div>`}function de(e){var s,i,r;if(!e)return'<div class="zone-empty"><span>🎣</span><strong>Select a PFZ zone</strong><p>Tap a coloured marine zone to see fish, safety and ocean telemetry.</p></div>';const t=E?`${te(E,e.coordinates).toFixed(1)} km from you`:"Enable GPS to calculate distance",n=(s=e.ocean)==null?void 0:s.wave,a=e.risk.level;return`
    ...
    <div class="zone-panel-heading">
      ...
      <span class="zone-risk ${a}">● ${F(e.risk.label)}</span>
    </div>
    ...
    <div class="zone-source">Demo advisory · existing ORCA mock data</div>`}async function Oe(e,{onAskOrca:t,onZoneChange:n}={}){K=n,e.innerHTML='<div class="marine-map-loading"><span>◌</span> Loading PFZ advisory layers…</div>';try{const a=await fetch("/api/marine-map");if(!a.ok)throw new Error("Map data request failed");const s=await a.json();ze(e,s,t)}catch(a){e.innerHTML='<div class="marine-map-loading map-load-error">⚠️ Marine advisory layers are unavailable. The chat remains available.</div>',console.error("Marine map:",a)}}function ze(e,t,n){var k;e.innerHTML=`
  ...
  `,setTimeout(()=>{const t=e.querySelector("#lang-picker");t&&(t.value=U(),t.addEventListener("change",a=>{$e(a.target.value),v&&(v.placeholder=ye())}));const n=e.querySelector("#voice-toggle");n&&n.addEventListener("click",()=>{const a=xe();n.classList.toggle("active",a),n.title=a?"Auto-speak: ON":"Auto-speak: OFF"})},0),e}function Ce(e,t=!1){const n=document.getElementById("header-agent-status");if(!n)return;const a=n.querySelector(".status-pulse-dot"),s=n.querySelector(".status-text");a&&(a.className=t?"status-pulse-dot scanning":"status-pulse-dot"),s&&(s.textContent=e)}function Be(){return`<select id="lang-picker" class="lang-picker" aria-label="Language">${Object.entries(oe).map(([t,n])=>`<option value="${t}">${n}</option>`).join("")}</select>`}function We(){const e=Ne();return`<button id="voice-toggle" class="voice-toggle-btn ${e?"active":""}" 
  ...
  `,x.appendChild(R),le(),D&&clearInterval(D),D=setInterval(()=>{e=(e+1)%X.length;const t=document.getElementById("activity-status-text");t&&(t.classList.remove("status-fade-in"),t.offsetWidth,t.textContent=X[e],t.classList.add("status-fade-in"))},1300)}function se(){D&&(clearInterval(D),D=null),Ce("Marine Core Active",!1),R&&(R.remove(),R=null)}function Y(e){if(se(),!x)return;const t=document.createElement("div");t.className="message assistant",t.innerHTML=`
    <div class="message-avatar" style="background: var(--accent-gradient);">🌊</div>
    <div class="message-content">
      <div class="error-message">⚠️ ${e}</div>
      <div class="message-time">${new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}</div>
    </div>
  `,x.appendChild(t),le()}function he(e){v&&(v.disabled=e),I&&(I.disabled=e),M&&(M.disabled=e)}function Le(e){v&&(v.value=e,v.style.height="auto",v.style.height=Math.min(v.scrollHeight,120)+"px",v.focus())}function Ue(e){if(M)switch(e){case"listening":M.classList.add("recording"),M.innerHTML="⏹️";break;case"stopped":case"error":case"denied":M.classList.remove("recording"),M.innerHTML="🎤";break}}function Qe(e){return e?e.replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/\n/g,"<br>"):""}function Ye(e){var s,i,r,c,o;const t=document.createElement("div");t.className="weather-card";const n=((s=e.weather)==null?void 0:s.icon)||"03d",a=Ie(n);return t.innerHTML=`
  ...
  `,t}function Ke(e){var a,s,i,r,c,o,p,y;const t=document.createElement("div");t.className="aqi-card";const n={1:"aqi-good",2:"aqi-fair",3:"aqi-moderate",4:"aqi-poor",5:"aqi-very-poor"}[(a=e.aqi)==null?void 0:a.index]||"aqi-moderate";return t.innerHTML=`
  ...
  `;const f=()=>{n&&p&&(a&&a.forEach(d=>d.classList.remove("pfz-card--active")),s.classList.add("pfz-card--active"),n.focusZone(p.lat,p.lon,e.name))},S=s.querySelector(".pfz-btn-map");S&&S.addEventListener("click",d=>{d.stopPropagation(),f()}),s.addEventListener("click",d=>{d.target.closest("button")||f()}),s.querySelectorAll(".pfz-species-pill").forEach(d=>{d.addEventListener("click",C=>{C.stopPropagation();const Z=d.getAttribute("data-species");z&&z(`What is the recommended gear, depth, and technique for catching ${Z} in ${e.name||"this zone"}?`)})});const $=s.querySelector(".pfz-btn-gps");$&&h&&$.addEventListener("click",d=>{d.stopPropagation(),navigator.clipboard.writeText(h).then(()=>{const C=$.innerHTML;$.innerHTML="✓ Copied!",$.classList.add("btn-copied"),setTimeout(()=>{$.innerHTML=C,$.classList.remove("btn-copied")},1800)})});const N=s.querySelector(".pfz-btn-weather");return N&&N.addEventListener("click",d=>{d.stopPropagation(),z&&z(`What are the wind and ocean conditions at ${e.name||"this location"}?`)}),s}function Xe(e){return e?e.confidence!=null?`${Math.round(e.confidence*100)}% confidence`:e.mg_m3!=null?`${e.mg_m3} mg/m³`:e.celsius!=null?`${e.celsius}°C`:e.significant_height_m!=null?`${e.significant_height_m} m`:e.condition!=null?e.condition:"Not available":"Not available"}function et(e){var f,S,$,N,q;const t=e.recommendation_result,n=t.selected_pfz,a=((S=(f=e.gis_result)==null?void 0:f.candidates)==null?void 0:S.find(T=>T.id===(n==null?void 0:n.id)))||(($=e.gis_result)==null?void 0:$.nearest_pfz),s=t.factors||{},i=document.createElement("section");i.className="recommendation-card";const r=document.createElement("div");r.className="recommendation-card-header";const c=document.createElement("div"),o=document.createElement("span");o.className="recommendation-kicker",o.textContent="ORCA FISHING RECOMMENDATION";const p=document.createElement("strong");p.textContent=(n==null?void 0:n.name)||"No PFZ recommended",c.append(o,p);const y=document.createElement("span"),h=t.safety_status||((N=e.safety_result)==null?void 0:N.status)||"UNKNOWN";y.className=`recommendation-safety recommendation-safety--${h.toLowerCase()}`,y.textContent=h,r.append(c,y),i.appendChild(r);const b=document.createElement("div");b.className="recommendation-summary";const u=document.createElement("div");u.innerHTML=`<span>Suitability</span><strong>${t.score??"—"}<small>/100</small></strong>`;const k=document.createElement("div");k.innerHTML=`<span>Distance</span><strong>${(a==null?void 0:a.distance_km)!=null?`${a.distance_km} km`:"Not available"}</strong>`,b.append(u,k),i.appendChild(b);const l=[["PFZ",[s.pfz]],["Ocean",[s.chlorophyll,s.sst,s.waves]],["Weather",[s.weather]]],m=document.createElement("div");if(m.className="recommendation-factors",l.forEach(([T,w])=>{const d=document.createElement("div");d.className="recommendation-factor-group";const C=document.createElement("span");C.textContent=T,d.appendChild(C),w.filter(Boolean).forEach(Z=>{const re=document.createElement("div");re.textContent=`${Xe(Z)} · ${Z.score}/${Z.weight_percent} pts`,d.appendChild(re)}),m.appendChild(d)}),i.appendChild(m),(q=t.reasons)!=null&&q.length){const T=document.createElement("ul");T.className="recommendation-reasons",t.reasons.slice(0,4).forEach(w=>{const d=document.createElement("li");d.textContent=w,T.appendChild(d)}),i.appendChild(T)}return i}function tt(e){var s;const t=document.createElement("div");t.className="forecast-chart-container";const n=document.createElement("div");n.className="forecast-chart-title",n.textContent=`📊 ${((s=e.forecast)==null?void 0:s.length)||5}-Day Forecast — ${e.city||""}`,t.appendChild(n);const a=document.createElement("div");return a.style.height="180px",a.style.position="relative",t.appendChild(a),setTimeout(()=>{Fe(a,e)},100),t}function at(e,t,n){const a=document.createElement("div");a.className="map-wrapper";const s=n&&n.zones&&n.zones.length>0,i=document.createElement("button");i.className="map-toggle-btn",i.innerHTML=s?"🗺️ Show PFZ zones on map":"📍 Show on map",i.setAttribute("aria-label","Show location on map");let r=!1,c=null,o=null;const p=[];function y(){if(!r){if(c=document.createElement("div"),c.className="map-container",s&&c.classList.add("map-container--pfz"),a.appendChild(c),window.L){o=L.map(c,{zoomControl:!0,attributionControl:!1}).setView([e.lat,e.lon],10),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:18}).addTo(o);const b=L.featureGroup();if(t){const u=L.marker([e.lat,e.lon]).bindPopup(`<b>${t}</b>`);u.addTo(o),b.addLayer(u)}s&&n.zones.forEach(u=>{var d,C;if(!u.coordinates)return;const{lat:k,lon:l}=u.coordinates,m=Math.round((u.confidence||0)*100),f=u.confidence_label||(u.confidence>=.8?"High":u.confidence>=.6?"Moderate":"Low"),S=u.confidence>=.8?"#4ade80":u.confidence>=.6?"#facc15":"#f87171",$=u.likely_species&&u.likely_species.length?u.likely_species.join(", "):"—",N=((d=u.conditions)==null?void 0:d.sst_celsius)!=null?u.conditions.sst_celsius+"°C":"—",q=((C=u.conditions)==null?void 0:C.chlorophyll_mg_m3)!=null?u.conditions.chlorophyll_mg_m3+" mg/m³":"—",T=`
            <div class="pfz-popup">
            ...
            </div>`,w=L.circleMarker([k,l],{radius:11,fillColor:"#14b8a6",fillOpacity:.9,color:"#ffffff",weight:2}).bindPopup(T,{className:"pfz-leaflet-popup",maxWidth:260});w.addTo(o),b.addLayer(w),p.push({zoneName:u.name,lat:k,lon:l,marker:w})}),b.getLayers().length>1?setTimeout(()=>{o.fitBounds(b.getBounds().pad(.15))},250):!t&&s&&o.setView([e.lat,e.lon],9),setTimeout(()=>o.invalidateSize(),200)}i.innerHTML=s?"🗺️ Hide map":"📍 Hide map",r=!0}}function h(){r&&(c&&c.remove(),c=null,o=null,p.length=0,i.innerHTML=s?"🗺️ Show PFZ zones on map":"📍 Show on map",r=!1)}return i.addEventListener("click",()=>{r?h():y()}),a.appendChild(i),{element:a,openMap:y,focusZone:(b,u,k)=>{r||y(),setTimeout(()=>{if(o){o.flyTo([b,u],11,{duration:.8});const l=p.find(m=>k&&m.zoneName===k||Math.abs(m.lat-b)<.005&&Math.abs(m.lon-u)<.005);l&&l.marker.openPopup()}a.scrollIntoView({behavior:"smooth",block:"nearest"})},150)}}}function nt(e){let t=[];if(e.pfzData&&e.pfzData.zones&&e.pfzData.zones.length>0)t=["🧭 Is navigation safe in these zones today?","💨 Wind & wave swell forecast for these zones","🎣 Recommended fishing gear & depth"];else if(e.weatherData){const a=e.weatherData.city||"this area";t=[`🎣 Show PFZ zones near ${a}`,"🌊 Ocean swell and wave height",`📊 5-day marine forecast for ${a}`]}else return null;const n=document.createElement("div");return n.className="followup-suggestions",n.innerHTML=`
    <div class="followup-title">⚡ Quick Marine Follow-ups</div>
    <div class="followup-chips">
      ${t.map(a=>`<button class="followup-chip" type="button">${a}</button>`).join("")}
    </div>
  `,n.querySelectorAll(".followup-chip").forEach(a=>{a.addEventListener("click",()=>{z&&z(a.textContent)})}),n}function le(){x&&requestAnimationFrame(()=>{x.scrollTop=x.scrollHeight})}const W=[],fe=20;let ie=null;function st(e,t){if(!e||!t)return null;const n=Math.PI/180,a=(t.lat-e.lat)*n,s=(t.lon-e.lon)*n,i=Math.sin(a/2)**2+Math.cos(e.lat*n)*Math.cos(t.lat*n)*Math.sin(s/2)**2;return 6371*2*Math.atan2(Math.sqrt(i),Math.sqrt(1-i))}function it(e,t){var n,a,s;if(!e){ie=null;return}ie={zoneName:e.name,state:e.state,coordinates:e.coordinates,confidence:e.confidence,targetSpecies:e.likely_species,sstCelsius:e.sst_celsius,chlorophyllMgM3:e.chlorophyll_mg_m3,windKnots:e.wind_speed_knots,waveHeightM:((a=(n=e.ocean)==null?void 0:n.wave)==null?void 0:a.significant_height_m)??null,riskStatus:(s=e.risk)==null?void 0:s.label,userLocation:t||null,distanceKm:st(t,e.coordinates),source:"ORCA existing mock PFZ/ocean advisory"}}async function ee(e){if(!e.trim())return;const t=U();ve("user",e),W.push({role:"user",content:e}),W.length>fe&&W.splice(0,W.length-fe),he(!0),je();try{const n=await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:e,language:t,mapContext:ie,history:W.slice(0,-1)})});if(se(),!n.ok){const s=await n.json().catch(()=>({}));n.status===401?Y(s.error||"API keys not configured. Check your .env file."):Y(s.error||"Something went wrong. Please try again.");return}const a=await n.json();ve("assistant",a.reply,{weatherData:a.weatherData,forecastData:a.forecastData,airQualityData:a.airQualityData,pfzData:a.pfzData,orchestratorData:a.orchestratorData,coordinates:a.coordinates}),W.push({role:"assistant",content:a.reply}),Ae(a.originalReply||a.reply)}catch(n){se(),n.name==="TypeError"&&n.message.includes("Failed to fetch")?Y("Cannot connect to the server. Make sure the backend is running (npm run dev)."):Y("An unexpected error occurred. Please try again."),console.error("Chat error:",n)}finally{he(!1)}}async function ge(){var t,n;const e=document.getElementById("app");if(e){Se(),Pe();try{const s=await(await fetch("/api/health")).json();(!((t=s.keys)!=null&&t.groq)||!((n=s.keys)!=null&&n.owm))&&console.warn("Some API keys are missing; map demo remains available.")}catch(a){console.warn("Health check failed — server may not be running:",a.message)}Re(e,{onSend:a=>ee(a),onSuggestion:a=>ee(a),onMapZoneChange:(a,s)=>it(a,s)}),be()&&Me(a=>{Le(a),ee(a)},a=>{Ue(a)}),console.log("🌊 ORCA initialized")}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ge):ge();
